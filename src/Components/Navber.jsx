...
const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full bg-base-100 shadow-lg z-50">
        <div className="navbar flex-wrap sm:flex-nowrap">
          {/* Navbar Start */}
          <div className="navbar-start">
            ...
            <Link className="text-blue-600 flex items-center" to="/">
              <img className="w-10 sm:w-12 inline mr-3" src={img} alt="Logo" />
              <span className="font-bold text-lg sm:text-xl">TourMate BD</span>
            </Link>
          </div>
      ...
      {/* Extra space to prevent content from being hidden behind the fixed navbar */}

...
const GuideDashboardLayout = () => {
  const navItems = [
    ...
    { name: "My Assigned Tour", path: "/dashboard/guide/my-assigned" },
    ...
    <div className="flex h-screen">
      ...
      >
        <div className="flex justify-between items-center mb-4 lg:hidden">
          <h2 className="text-xl font-bold">Guide Dashboard</h2>
          <button onClick={toggleSidebar} className="text-white">
            <FaTimes className="text-2xl" />
          </button>
        </div>
        <h2 className="hidden lg:block text-xl font-bold mb-4">Guide Dashboard</h2>
      ...
      <main className="flex-1 p-6 bg-gray-100 overflow-auto">
        <div className="flex items-center justify-between mb-4 lg:hidden">
          <h2 className="text-lg font-semibold">Guide Dashboard</h2>
